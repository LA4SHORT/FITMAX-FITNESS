    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Why Choose <span className="text-primary">FITMAX+</span> Fitness?
          </motion.h2>
          <motion.p
          ...
          >
            We provide all your needs to succeed on your fitness journey with
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <motion.div
                className="w-16 h-16 rounded-full bg-primary/20 inline-flex items-center justify-center group-hover:bg-primary 
                group-hover:text-primary-foreground transition-colors duration-300 mb-6"
              ...
              <motion.h3
                className="text-xl font-bold font-heading mb-4 text-forground"
