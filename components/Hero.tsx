    ...
    <section className="h-screen relative flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 text-white text-center px-4 max-w-4xl">
        <div>
          ...
          >
            Join us now and achieve your fitness goals with expert trainers and
            personalized plans.
          </motion.p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-primary-forground rounded-full flex justify-center">
