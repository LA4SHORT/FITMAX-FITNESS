...
export const programs = [
  {
    ...
    description:
      "Build muscle and increase your power with out comprehensive strength training programs.",
    image: "/strength.jpg",
  },
...
export const testimonials = [
  ...
  {
    name: "John D.",
    story: "The trainers push me beyong my limit in a healthy way.",
    details:
